...
// ===============================
// 🔐 Função de senha forte (ADICIONADA)
// ===============================
...
// 🚨 BLOQUEAR SENHA FRACA NO BACKEND
if (!senhaForte(senha)) {
  return res.status(400).json({
    success: false,
    error: "A senha deve ter no mínimo 8 caracteres, incluir número, letra maiúscula, letra minúscula e símbolo."
  });
}
